...
int main(int argc, char *argv[]) {
  ...
  for (int iteration = 0; iteration < options.iterations; iteration += options.iteration_step) {
    ...
    features.run_iterations(options.iteration_step, options.stage1_only);
    gsoc_2018.run_iterations(options.iteration_step, options.stage1_only);
    twitter.run_iterations(options.iteration_step, options.stage1_only);
    random.run_iterations(options.iteration_step, options.stage1_only);
  }
